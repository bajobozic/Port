...
internal interface NetworkRepository {
    suspend fun getMovies(language: String, page: Int): Outcome<PopularMoviesResponse, BaseError>
    suspend fun getGenres(language: String): Outcome<GenreResponse, BaseError>
