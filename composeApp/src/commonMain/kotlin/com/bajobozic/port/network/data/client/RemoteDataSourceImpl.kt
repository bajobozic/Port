...
import com.bajobozic.port.network.data.dto.GenreResponse
import com.bajobozic.port.network.data.dto.MovieDetailResponse
import com.bajobozic.port.network.data.dto.MovieGenresIds
import com.bajobozic.port.network.data.dto.MovieVideoDto
import com.bajobozic.port.network.data.dto.MoviesResponse
import com.bajobozic.port.network.data.dto.PopularMoviesResponse
import com.bajobozic.port.network.data.dto.initKeys
import com.bajobozic.port.network.data.dto.toMoviesResponse
...
internal class RemoteDataSourceImpl(private val apiClient: ApiClient) :
    ...
    override suspend fun getMovieGenresAndIds(
        ...
        return MovieGenresIds(listOf(movie), genres, list)
    }
